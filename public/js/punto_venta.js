document.addEventListener('DOMContentLoaded', () => {
    ...
    categoriaCards.forEach(card => {
        card.addEventListener('click', () => {
            ...
            productosContainer.style.display = 'flex'; // ✅ Mostrar contenedor de productos
    ...
    // 🔽 Agregar producto a la tabla de la factura con botones de cantidad
    window.agregarProducto = function(id, nombre, precio) {
        ...
        // Actualiza totales al cambiar cantidad
        ...
        // Evento restar cantidad (mínimo 1)
